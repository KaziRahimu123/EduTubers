          ...
          <div className="mb-6">
            ...
            {(contentType === 'branded_guide' || contentType === 'resource_page') && (
              <div className="bg-white rounded-xl border border-gray-200 p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-700">Generate images for this asset</p>
                    <p className="text-xs text-gray-400 mt-0.5">AI-generated images with editable captions · Max 20 per 3 days</p>
                  </div>
